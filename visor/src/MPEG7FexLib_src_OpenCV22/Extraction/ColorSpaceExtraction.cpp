...
#include <visor/MPEG7FexLib_src_OpenCV22/Descriptors/ColorSpace.h>                     /* Naming Convention */
#include <visor/MPEG7FexLib_src_OpenCV22/Extraction/ColorSpaceExtraction.h>
